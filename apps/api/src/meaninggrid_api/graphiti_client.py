"""Shared Graphiti client for read endpoints.

Worker has its own instance for writes; both point at the same FalkorDB and the
same LLM/embedder (Ollama by default — see settings.py).
"""
