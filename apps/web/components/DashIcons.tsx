...
export const Icon = {
  ...
  stripe: ({ size = 18 }: P) => (
    // Official Stripe brand mark ("S" glyph) in Stripe's brand purple.
    <svg width={size} height={size} viewBox="0 0 24 24" fill="#635BFF" aria-hidden="true">
      <path d="M11.319 9.41c0-.674.555-.933 1.47-.933 1.315 0 2.976.398 4.291 1.108V5.59a11.41 11.41 0 0 0-4.291-.79c-3.508 0-5.843 1.83-5.843 4.888 0 4.772 6.57 4.01 6.57 6.07 0 .796-.693 1.055-1.659 1.055-1.435 0-3.27-.59-4.722-1.388v4.07a11.985 11.985 0 0 0 4.722.985c3.595 0 6.07-1.778 6.07-4.872 0-5.152-6.608-4.235-6.608-6.196z" />
    </svg>
  ),
  sources: (p: P) => (
    <Svg {...p}>
